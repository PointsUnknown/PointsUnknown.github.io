...
map.on("load", function () {
  ...
  map.loadImage(
    "https://docs.mapbox.com/mapbox-gl-js/assets/custom_marker0.png",
    (error, image) => {
  ...
  map.addLayer(
    {
      ...
      source: {
        type: "geojson",
        data: "data/customMarker.geojson",
      },
      layout: {
  ...
  map.addLayer(
    {
      ...
      source: {
        type: "geojson",
        data: "data/customMarker 02.geojson",
      },
      layout: {
        "icon-image": "custom-marker",
        // get the title name from the source's "title" property
  ...
  map.addLayer(
    {
      ...
      paint: {
        ...
        "fill-opacity": ["case", ["==", ["get", "mhhi19"], null], 0, 0.65],
      },
    },
    "waterway-shadow"
  );
  ...
  map.addLayer(
    {
      id: "Percentage_of_Residential_Properties_that_are_Vacant_and_Abandoned",
      type: "fill",
      source: {
        type: "geojson",
        data: "data/Percentage_of_Residential_Properties_that_are_Vacant_and_Abandoned.geojson",
      },
      paint: {
        "fill-color": [
          "step",
        ...
        "fill-opacity": ["case", ["==", ["get", "vacant20"], null], 0, 0.65],
      },
    },
    "waterway-shadow"
  );
  ...
  map.addLayer(
    {
      id: "Percent_of_Residents_-_Black_African-American_(Non-Hispanic)",
      type: "fill",
      source: {
        type: "geojson",
        data: "data/Percent_of_Residents_-_Black_African-American_(Non-Hispanic).geojson",
      },
      paint: {
        "fill-color": [
          "step",
        ...
        "fill-opacity": ["case", ["==", ["get", "paa20"], null], 0, 0.65],
      },
    },
    "waterway-shadow"
  );
  ...
  map.addLayer({
    id: "grocery_data_sandtown",
    type: "circle",
    source: {
      type: "geojson",
      data: "data/grocery_data_sandtown.geojson",
    },
    paint: {
      "circle-color": "#ff7f50",
  ...
  map.addSource("boundary", {
    ...
    data: {
      ...
      geometry: {
        type: "LineString",
        coordinates: [
          [-436.64817810058594, 39.30976324724294],
          [-436.64746999740595, 39.29757595606421],
          [-436.6339087486267, 39.29800769472928],
          [-436.63860797882074, 39.30677473462728],
          [-436.64238452911377, 39.310095296322245],
          [-436.64817810058594, 39.30976324724294],
        ],
      },
    },
  ...
  map.addSource("route", {
    ...
    data: {
      ...
      geometry: {
        type: "LineString",
        coordinates: [
          [-436.6446375846863, 39.303420807386516],
          [-436.644766330719, 39.305363448196296],
          [-436.6449165344238, 39.30800336081796],
          [-436.64358615875244, 39.30806977242999],
          [-436.6432213783264, 39.30318835102808],
          [-436.63860797882074, 39.30335439136288],
        ],
      },
    },
  });
