...
* US Counties 1:500,000 (clipped to shoreline). Download from [US Census Bureau](https://www2.census.gov/geo/tiger/GENZ2019/shp/cb_2019_us_county_500k.zip).
...
* Covid-19 cases. Download from [John Hopkins University - CSSE Covid-19 Daily Reports](https://github.com/CSSEGISandData/COVID-19/tree/master/csse_covid_19_data/csse_covid_19_daily_reports)
...
* Next, let's change the project's `CRS` to the standard US projection:
  ...
  * Start by clicking `Cancel` on the window that is asking you to select the transformation. And then `Close` the window where you selected the vector layer to add.
